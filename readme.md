...
Welcome to the Bakery by Merci project! This Django application is designed to manage a bakery shop's products, orders, and users efficiently.
...
```bash
psql -U postgres CREATE DATABASE bbmerci;
```
Apply migrations 
